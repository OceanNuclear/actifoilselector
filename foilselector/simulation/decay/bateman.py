...
def Bateman_num_decays_factorized(
    branching_ratios,
    decay_constants,
    a,
    b,
    ...
    try:
        ...
        return Bateman_num_decays_factorized(
            branching_ratios,
            decay_constants_copy,
            a,
            b,
            c,
            DEBUG,
...
def mat_exp_population_convolved(
    ...
    if (
        ...
        matrix, iden = (
            ...
            np.identity(len(decay_constants) - 1),
        )
