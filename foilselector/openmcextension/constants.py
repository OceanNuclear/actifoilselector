...
from openmc.data import NATURAL_ABUNDANCE, ATOMIC_NUMBER  # atomic data look up tables
from openmc.data import atomic_mass  # atomic data lookup
...
AMBIGUOUS_MT = (1, 3, 5, 18, 27, 101, 201, 202, 203, 204, 205, 206, 207)
