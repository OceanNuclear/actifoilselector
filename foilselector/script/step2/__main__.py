...
SORT_BY_REACTION_RATE = True
SHOW_SEPARATE_MT_REACTION_RATES = False
...
stage1_outputs_exist = all(os.path.exists(os.path.join(sys.argv[-1], FULL_DECAY_INFO_FILE)),
...
if not stage1_outputs_exist:
    ...
    sigma_df = pd.read_csv(os.path.join(sys.argv[-1], MICROSCOPIC_XS_CSV), index_col=[0])
